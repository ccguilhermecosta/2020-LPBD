...
/*CRIAÇAO DE TODAS AS CHAVES PRIMARIAS UTILIZANDO O PREFIXO 'PK'*/
...
ALTER TABLE RECEBER
ADD CONSTRAINT PK2_ID_FINANCEIRO
    PRIMARY KEY (FK2_ID_FINANCEIRO);
    
ALTER TABLE PAGAR
ADD CONSTRAINT PK3_ID_FINANCEIRO
    PRIMARY KEY (FK_ID_FINANCEIRO);
